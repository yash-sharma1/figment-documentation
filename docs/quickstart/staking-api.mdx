...
<details><summary>Click here to view the list of endpoints for the Staking API</summary>
...
- `https://polygon-slate.datahub.figment.io/api/v1/flows`
- `https://polygon-slate.datahub.figment.io/api/v1/flows/[:flow_id]/next`
...
```text {5-10} title="Example curl request"
...
```javascript {8-13} title="Example JavaScript Fetch request"
...
```text {1,5,7-11,27} title="Example curl request to continue a NEAR staking flow"
...
```javascript {2,9,11-15} title="Example JavaScript Fetch request"
const API_KEY = "YOUR API KEY";
...
<details><summary>Click to view the list of URLs for Staking API Webhooks</summary>
...
```text {5-9} title="Example curl request POST /webhook_endpoints"
...
```javascript {8-12} title="Example JavaScript Fetch request"
const API_KEY = "YOUR API KEY";
...
```json {8} title="Example JSON response"
{
  "id": 16,
  "event_types": [],
  "target_url": "https://example.com/my/endpoint",
...
```javascript {2,14} title="Example JavaScript Fetch request"
const API_KEY = "YOUR API KEY";
...
```text {6,8} title="Example curl request PUT /webhook_endpoints/[:webhook_endpoint_id]"
...
```javascript {2, 10, 11, 24} title="Example JavaScript Fetch request"
const API_KEY = "YOUR API KEY";
...
```json {4} title="Example JSON response"
{
  "id": 15,
  "event_types": ["*"],
  "target_url": "https://example.com/my/new/endpoint",
...
See the Guide [**Working With Staking API Flows**](/guides/staking-api) for more details about using the Staking API.
