...
Since delegations on Solana activate at the next epoch boundary (epochs are approximately 2.5 days), Slate will also track the delegation and send a webhook notification when it activates.
