...
If the account does not need to be chilled, you can skip to [Create Unbond Transaction](/guides/slate-flows/polkadot/undelegate/create-unbond-transaction)

If you want to skip the unbonding process as well, you can skip to [Create Withdraw Transaction](/guides/slate-flows/polkadot/undelegate/create-withdraw-transaction)
