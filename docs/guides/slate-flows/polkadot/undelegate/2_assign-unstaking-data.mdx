...
If chilling is required before unbonding, we will be required to create a chill transaction: [3. Create Chill Transaction](/guides/slate-flows/polkadot/undelegate/create-chill-transaction)

If no chilling is required, we can move straight to creating the unbond transaction: [6. Create Unbond Transaction](/guides/slate-flows/polkadot/undelegate/create-unbond-transaction)
