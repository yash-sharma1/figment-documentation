...
- `delegator_pubkey` (**required**) — The pubkey of the signing account
- `validator_address` (**required**) — Validator address from which LUNA will be un-delegated
- `withdraw_amount` (**required**) — the amount of NEAR to be withdrawn
- `withdraw_maximum` (_optional_) — Set to true if you wish to withdraw the full available balance without needing to know the exact available balance.
