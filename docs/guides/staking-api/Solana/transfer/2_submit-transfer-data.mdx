...
- `name` &mdash; `string` Name of the action to execute i:e; `create_transfer_tx`
- `inputs` &mdash; `array`
  - `from_account_pubkey` &mdash; `string` The wallet SOL will be originating from (required).
