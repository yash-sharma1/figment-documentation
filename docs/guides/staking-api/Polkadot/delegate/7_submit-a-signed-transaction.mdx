...
Since nominations on Polkadot activate at the next epoch boundary (epochs are approximately 1 day), the Staking API will also track the nomination and send a webhook notification when it activates.
