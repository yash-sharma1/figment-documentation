...
After successfully submitting the staking account data, in response you have received the `transaction_payload`, you'll be using this `transaction_payload` to sign the transaction for confirmation.
