...
slug: /guides/staking-api/polkadot/remove-staking-proxy/submit-proxy-data
---
...
- `inputs` &mdash; `array`
  - `proxy_account_address` &mdash; `string` The address to which you want to remove proxy rights (required).
