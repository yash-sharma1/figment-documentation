...
After successfully submitting the withdraw transaction data, in response you have received the `transaction_payload`, you'll be using this `transaction_payload` to sign the transaction for confirmation.
...
Figment has a tool for signing and decoding payloads, see the [guide](/guides/staking-api/figment-signing-transactions) to continue.
