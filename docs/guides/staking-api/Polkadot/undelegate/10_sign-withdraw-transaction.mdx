...
After successfully submiting the withdraw transaction data, in reasponse you have received the `transaction_payload`, you'll be using this `transaction_payload` to sign the transaction for confirmation.
