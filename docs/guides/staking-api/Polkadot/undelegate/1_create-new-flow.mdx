...
If you want to skip the unbonding process as well, proceed to [Create Withdraw Transaction](/guides/staking-api/polkadot/undelegate/create-withdraw-transaction).
