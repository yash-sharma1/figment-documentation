...
- `inputs` &mdash; `array`
  ...
  - `validator_address` &mdash; `string` Validator address from which NEAR will be un-delegated (required).
  - `undelegate_amount` &mdash; `number` The amount of NEAR to be un-delegated (required).
