...
If you are using Fireblocks as a custodial solution check the following page for instructions on using the raw signing capabilities of Fireblocks: <Link to="/guides/staking-api-flows/fireblocks-signing-transactions">Signing Staking API Transactions with Fireblocks</Link>
